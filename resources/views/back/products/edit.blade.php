                    ...
                    <form role="form" action="{{ route('backproducts.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ $product->name }}" placeholder="Entrer le nom de la marque">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                    <input type="date" class="form-control @error('release_date') is-invalid @enderror" name="release_date" id="release_date" value="{{ $product->release_date }}"/>
                            ...
                            <div class="form-group">
                                ...
                                <select name="is_published" class="form-control select2bs4 @error('is_published') is-invalid @enderror" style="width: 100%;">
                                    <option selected="selected" value="{{ $product->is_published }}">{{ $product->is_published }}</option>
                            ...
                            <div class="form-group">
                                ...
                                <select name="brand" class="form-control select2bs4 @error('brand') is-invalid @enderror" style="width: 100%;">
                                    <option selected="selected" value="{{ $product->brand->id }}">{{ $product->brand->name }}</option>
